function InfoChiSiamo() {
  return (
    <div className=" text-[#f3ece0] py-12 pb-16 text-center justify-center ">
      <div className="container grid grid-cols-2 md:grid-cols-4   ">
        <div className="text-xs bg-[#2389a0] rounded-xl m-4 p-2 drop-shadow-[0_4px_6px_rgba(0,0,0,0.8)] hover:!scale-110 hover:!shadow-xl duration-300  select-none">
